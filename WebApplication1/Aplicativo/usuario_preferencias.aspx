...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_Body" runat="server">
    ...
    <div class="opaco">
        <%--<h2>Estilo
        <br />
            <small>seleccione el estilo que le sienta más cómodo, el mismo se aplicará cada vez que ingrese</small></h2>
        <div class="row">
            <div class="row">
                <div class="col-md-12">
        ...
        <h2>Contraseña
        <br />
            <small>aquí podrá cambiar su contraseña</small></h2>
        <br />
        <div class="row">
        ...
        <h2>Correo
        <br />
            <small>se muestra información del correo actual y su estado. Aquí podra modificar su correo y validarlo.</small></h2>
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-inverse">
                    <div class="container-fluid">
